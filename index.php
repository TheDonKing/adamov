            ...
            <div class="row">
                ...
                <div class="description">
                    <div class="description-box">
                        <p>Оценка профессионального уровня специалистов и качества лечения</p>
                    </div>
                    <div class="description-box">
                        <p>Оценка уровня сервиса и лояльности администрации к клиенту</p>
                    </div>
                    <ul class="ch-grid">
                        <li><img src="" alt=""/>
                            <h4>Мадина Магомедова</h4>
                            <small>Вид услуги:<a> Физиопроцедуры</a></small>
                            <p><span>отлично</span><span>отлично</span></p>

                            <p>Хожу сюда около 10-ти дней. Очень хорошие специалисты. Особенно Асия Ильясовна. Меня всё
                                устраивает.</p>

                            <p class="date">Дата: 19.07.15</p>
                        </li>
                        <li><img src="" alt=""/>
                            <h4>Мадина Магомедова</h4>
                            <small>Вид услуги: Физиопроцедуры</small>
                            <p><span>отлично</span><span>отлично</span></p>
